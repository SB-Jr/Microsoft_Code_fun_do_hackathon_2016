...
METADATA['en'].about = [
      ...
      }, 
      {
        ...
        "summary":"Wear 2.0 is still in active development, but you can try it as part of the Wear 2.0 Developer Preview. The sections below highlight some of the new features for developers. The preview introduces powerful additions to the user interface, opening up exciting\u2026",
      ...
      }, 
      {
        ...
        "summary":"If you want an environment for basic compatibility testing, you can use your current APK and a supported watch or an emulator. You don&#39;t necessarily need to update your full development environment to do basic testing. To simply test your app&#39;\u2026",
      ...
      }, 
      {
        ...
        "summary":"With Android Wear 2.0, a user can visit the Play Store on a watch and download a Wear app directly to the watch. Generally, a Wear 2.0 app in the Play Store needs a minimum and target API level of 24 or higher in the Android manifest file. The minimum\u2026",
        "url":"wear/preview/features/app-distribution.html",
        "image":"images/cards/card-n-sdk_2x.png",
        "category":"wear preview",
        "type":"about",
        "keywords": ["wear-preview"],
      ...
      }, 
      {
        ...
        "summary":"By default, notifications are bridged (shared) from an app on a companion phone to the watch. If you build a standalone watch app and have a companion phone app, they may duplicate notifications. The Android Wear 2.0 Preview includes features to handle\u2026",
      ...
      }, 
      {
        ...
        "summary":"In Android Wear 2.0, apps can work independently of a phone. Users can complete more tasks on a watch, without access to an Android or iOS phone. A watch APK targeting Wear 2.0 should not be embedded in a phone APK. For more information, see App Distribution\u2026",
        "url":"wear/preview/features/standalone-apps.html",
        "image":"images/cards/card-n-sdk_2x.png",
        "category":"wear preview",
        "type":"about",
        "keywords": ["wear-preview"],
      ...
      }, 
      {
        ...
        "type":"about",
        "keywords": [],
        "tags": ["wear","wear-preview","notificationspage.tags=wear"],
        "lang":"en"
      }, 
      {
      ...
      {
        "title":"Curved Layout",
        "summary":"Wear 2.0 introduces the WearableRecyclerView class for displaying and manipulating a vertical list of items optimized for round displays. WearableRecyclerView extends the existing RecyclerView class to provide a curved layout and a circular scrolling \u2026",
        "url":"wear/preview/features/wearable-recycler-view.html",
        "image":"wear/preview/images/wrv_new.png",
        "category":"wear preview",
        "type":"about",
        "keywords": ["wear"],
        "tags": ["wear","wear-preview","recyclerview"],
        "lang":"en"
      }, 
      {
      ...
      }, 
      {
        ...
        "summary":"I have read and agree with the above terms and conditions You can run and test your app with the Android Wear 2.0 Preview in either of these ways: If you want an environment for basic compatibility testing of your app, you can use your current APK and\u2026",
      ...
      }, 
      {
        ...
        "category":"versions",
        "type":"about",
        "keywords": ["androidn","versions"],
        "tags": ["androidn","nougat","android7.0"],
        "lang":"en"
      }, 
      {
        ...
        "category":"versions",
        "type":"about",
        "keywords": ["android 7.0","nougat","android n"],
        "tags": ["nougat","androidn","compatibility"],
        "lang":"en"
      }, 
      {
        "title":"Android 7.0 for Developers",
        "summary":"Android 7.0 Nougat introduces a variety of new features and capabilities for users and developers. This document highlights what&#39;s new for developers. Make sure check out the Android 7.0 behavior changes to learn about areas where platform changes\u2026",
        "url":"about/versions/nougat/android-7.0.html",
        "image":"images/cards/card-n-apis_2x.png",
        "category":"versions",
        "type":"about",
        "keywords": ["android 7.0","nougat","android n"],
        "tags": ["nougat","androidn"],
        "lang":"en"
      }, 
      {
        "title":"Android 7.0 Samples",
        "summary":"Use the code samples below to learn about Android 7.0 capabilities and APIs. To download the samples in Android Studio, select the File &gt; Import Samples menu option. This sample demonstrates how to take advantage of multiple window user interfaces \u2026",
...
METADATA['en'].develop = [
      ...
      }, 
      {
        ...
        "summary":"By default, Auto Backup includes files in most of the directories that are assigned to your app by the system: Auto Backup excludes files in directories returned by getCacheDir(), getCodeCacheDir(), or getNoBackupFilesDir(). The files saved in these locations\u2026",
        "url":"guide/topics/data/autobackup.html",
      ...
      }, 
      {
        ...
        "summary":"Users often invest significant time and effort creating data and setting preferences within apps. Preserving that data for users if they replace a broken device or upgrade to a new one is an important part of ensuring a great user experience. This section\u2026",
      ...
      }, 
      {
        ...
        "summary":"This page shows you how to manually trigger Auto Backup, Key&#47;Value Backup, and restore operations to ensure your app saves and restores data properly. The section describes various pieces in the Android backup framework and how they interact with \u2026",
        "url":"guide/topics/data/testingbackup.html",
        "image":"images/backup-framework.png",
        "category":"guide",
        "type":"develop",
        "keywords": ["backup","marshmallow","androidm"],
        "tags": ["backup","marshmallow","androidm"],
      ...
      }, 
      {
        ...
        "summary":"Since Android 2.2 (API 8), Android has offered the Key&#47;Value Backup feature as a way for developers to backup app data to the cloud. The Key&#47;Value Backup feature (formerly known as the Backup API and the Android Backup Service) preserves app data\u2026",
        "url":"guide/topics/data/keyvaluebackup.html",
        "category":"guide",
        "type":"develop",
        "keywords": ["backup","marshmallow","androidm"],
        "tags": ["backup","marshmallow","androidm"],
      ...
      }, 
      {
        ...
        "image":"images/android-7.0/notifications-card.png",
        "category":"guide",
        "type":"develop",
      ...
      }, 
      {
        ...
        "summary":"To show a first-time user how to get the most from your app, present onboarding information at app startup. Here are some examples of onboarding information: The v17 Leanback support library provides the OnboardingFragment class for presenting first-time\u2026",
        "url":"training/tv/playback/onboarding.html",
        "image":"images/training/tv/playback/onboarding-fragment.png",
        "category":"training",
        "type":"develop",
        "keywords": ["tv","onboarding","onboardingfragment"],
        "tags": ["tv","onboarding","onboardingfragment"],
        "lang":"en"
      }, 
      {
      ...
      }, 
      {
        ...
        "summary":"This lesson shows you how to create a new Android project with Android Studio and describes some of the files in the project. Android Studio fills in the package name and project location for you, but you can edit these if you&#39;d like. The Minimum \u2026",
      ...
      }, 
      {
        ...
        "summary":"In the previous lesson , you created an Android project that displays &quot;Hello World.&quot; You can now run the app on a real device or on an emulator. If you don&#39;t have a real device available, skip to Run on an Emulator . Set up your device as\u2026",
      ...
      }, 
      {
        ...
        "summary":"These classes and articles help you build an app that&#39;s smooth, responsive, and uses as little battery as possible. Along with this section, you can find additional information about optimizing your app in the Performance and Power section.\u2026",
      ...
      }, 
      {
        ...
        "summary":"Improve network performance by optimizing image size.",
        "url":"topic/performance/network-xfer.html",
        "image":"topic/performance/images/beforeafterindexed.png",
        "category":"performance",
        "type":"develop",
        "keywords": ["performance"],
        "tags": ["performance"],
      ...
      {
        "title":"Rendering",
        "summary":"Learn how to optimize your app's rendering performance.",
        "url":"topic/performance/rendering/index.html",
        "category":"performance",
        "type":"develop",
        "keywords": ["battery"],
        "tags": ["battery"],
      ...
      }, 
      {
        ...
        "summary":"Improve performance by reducing unnecessary rendering.",
        "url":"topic/performance/rendering/overdraw.html",
        "category":"performance",
        "type":"develop",
        "keywords": ["performance"],
        "tags": ["performance"],
      ...
      }, 
      {
        ...
        "summary":"Use the Profile GPU tool to help you optimize your app's rendering performance.",
        "url":"topic/performance/rendering/profile-gpu.html",
        "image":"topic/performance/images/bars.png",
        "category":"performance",
        "type":"develop",
        "keywords": ["power"],
        "tags": ["power"],
      ...
      }, 
      {
        ...
        "url":"topic/performance/rendering/optimizing-view-hierarchies.html",
      ...
      }, 
      {
        ...
        "summary":"Random-access memory (RAM) is a valuable resource in any software development environment, but it&#39;s even more valuable on a mobile operating system where physical memory is often constrained. Although both the Android Runtime (ART) and Dalvik virtual\u2026",
        "url":"topic/performance/memory.html",
        "category":"performance",
        "type":"develop",
      ...
      }, 
      {
        ...
        "summary":"The Android Runtime (ART) and Dalvik virtual machine use paging and memory-mapping (mmapping) to manage memory. This means that any memory an app modifies\u2014whether by allocating new objects or touching mmapped pages\u2014remains resident in RAM and cannot be\u2026",
        "url":"topic/performance/memory-overview.html",
        "category":"performance",
        "type":"develop",
        "keywords": ["ram","memory","paging","mmap"],
        "tags": ["ram","memory","paging","mmap"],
        "lang":"en"
      }, 
      {
      ...
      }, 
      {
        ...
        "summary":"Learn how to help your app go easier on the battery.",
        "url":"topic/performance/power/index.html",
        "category":"performance",
        "type":"develop",
        "keywords": ["performance"],
        "tags": ["performance"],
      ...
      }, 
      {
        ...
        "summary":"Improve network performance by optimizing image size.",
        "url":"topic/performance/power/battery-historian.html",
        "image":"topic/performance/images/generic-timeline.png",
        "category":"performance",
        "type":"develop",
        "keywords": ["power"],
        "tags": ["power"],
